...
test.describe('Create wallet-1', () => {
  test('backup wallet from banner on home screen-1', async () => {
  ...
  test('Default wallet-OFF, Product Analytics-OFF-1', async () => {
    const password = 'Trust@1234';
    await Steps.onboarding.verifyOnboardingPage();
  ...
  test('Default wallet-ON, Product Analytics-ON-1', async () => {
    const password = 'Trust@1234';
    await Steps.onboarding.verifyOnboardingPage();
    await Steps.onboarding.createNewWallet({ 
      password: password, 
